 ...
 264                     ; 90 void I2C_Init(uint32_t OutputClockFrequencyHz, uint16_t OwnAddress, 
 264                     ; 91               I2C_DutyCycle_TypeDef I2C_DutyCycle, I2C_Ack_TypeDef Ack, 
 264                     ; 92               I2C_AddMode_TypeDef AddMode, uint8_t InputClockFrequencyMHz )
 264                     ; 93 {
 265                     	switch	.text
 266  0025               _I2C_Init:
 268  0025 520d          	subw	sp,#13
 269       0000000d      OFST:	set	13
 272                     ; 94   uint16_t result = 0x0004;
 274                     ; 95   uint16_t tmpval = 0;
 276                     ; 96   uint8_t tmpccrh = 0;
 278  0027 0f0b          	clr	(OFST-2,sp)
 280                     ; 99   assert_param(IS_I2C_ACK_OK(Ack));
 ...
 302  004c               L41:
 303                     ; 100   assert_param(IS_I2C_ADDMODE_OK(AddMode));
 ...
 322  0069               L22:
 323                     ; 101   assert_param(IS_I2C_OWN_ADDRESS_OK(OwnAddress));
 ...
 339  0083               L62:
 340                     ; 102   assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));  
 ...
 359  00a0               L43:
 360                     ; 103   assert_param(IS_I2C_INPUT_CLOCK_FREQ_OK(InputClockFrequencyMHz));
 ...
 378  00bd               L04:
 379                     ; 104   assert_param(IS_I2C_OUTPUT_CLOCK_FREQ_OK(OutputClockFrequencyHz));
 ...
 438  011a               L25:
 439                     ; 125     tmpccrh = I2C_CCRH_FS;
 441  011a a680          	ld	a,#128
 442  011c 6b0b          	ld	(OFST-2,sp),a
 444                     ; 127     if (I2C_DutyCycle == I2C_DUTYCYCLE_2)
 446  011e 0d16          	tnz	(OFST+9,sp)
 447  0120 2642          	jrne	L531
 448                     ; 130       result = (uint16_t) ((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz * 3));
 ...
 489  0164               L531:
 490                     ; 135       result = (uint16_t) ((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz * 25));
 ...
 558                     ; 151     I2C->TRISER = (uint8_t)tmpval;
 560  01c3 7b0a          	ld	a,(OFST-3,sp)
 561  01c5 c7521d        	ld	21021,a
 563  01c8 2055          	jra	L341
 564  01ca               L331:
 565                     ; 158     result = (uint16_t)((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz << (uint8_t)1));
 ...
 664  0252 81            	ret
 720                     ; 196 void I2C_Cmd(FunctionalState NewState)
 720                     ; 197 {
 721                     	switch	.text
 722  0253               _I2C_Cmd:
 724  0253 88            	push	a
 725       00000000      OFST:	set	0
 728                     ; 200   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 730  0254 4d            	tnz	a
 ...
 746  026e               L26:
 747                     ; 202   if (NewState != DISABLE)
 749  026e 0d01          	tnz	(OFST+1,sp)
 750  0270 2706          	jreq	L571
 751                     ; 205     I2C->CR1 |= I2C_CR1_PE;
 753  0272 72105210      	bset	21008,#0
 755  0276 2004          	jra	L771
 756  0278               L571:
 757                     ; 210     I2C->CR1 &= (uint8_t)(~I2C_CR1_PE);
 759  0278 72115210      	bres	21008,#0
 760  027c               L771:
 761                     ; 212 }
 764  027c 84            	pop	a
 765  027d 81            	ret
 801                     ; 220 void I2C_GeneralCallCmd(FunctionalState NewState)
 801                     ; 221 {
 802                     	switch	.text
 803  027e               _I2C_GeneralCallCmd:
 805  027e 88            	push	a
 806       00000000      OFST:	set	0
 809                     ; 224   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 811  027f 4d            	tnz	a
 ...
 827  0299               L27:
 828                     ; 226   if (NewState != DISABLE)
 830  0299 0d01          	tnz	(OFST+1,sp)
 831  029b 2706          	jreq	L712
 832                     ; 229     I2C->CR1 |= I2C_CR1_ENGC;
 834  029d 721c5210      	bset	21008,#6
 836  02a1 2004          	jra	L122
 837  02a3               L712:
 838                     ; 234     I2C->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 840  02a3 721d5210      	bres	21008,#6
 841  02a7               L122:
 842                     ; 236 }
 845  02a7 84            	pop	a
 846  02a8 81            	ret
 882                     ; 246 void I2C_GenerateSTART(FunctionalState NewState)
 882                     ; 247 {
 883                     	switch	.text
 884  02a9               _I2C_GenerateSTART:
 886  02a9 88            	push	a
 887       00000000      OFST:	set	0
 890                     ; 250   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 892  02aa 4d            	tnz	a
 ...
 908  02c4               L201:
 909                     ; 252   if (NewState != DISABLE)
 911  02c4 0d01          	tnz	(OFST+1,sp)
 912  02c6 2706          	jreq	L142
 913                     ; 255     I2C->CR2 |= I2C_CR2_START;
 915  02c8 72105211      	bset	21009,#0
 917  02cc 2004          	jra	L342
 918  02ce               L142:
 919                     ; 260     I2C->CR2 &= (uint8_t)(~I2C_CR2_START);
 921  02ce 72115211      	bres	21009,#0
 922  02d2               L342:
 923                     ; 262 }
 926  02d2 84            	pop	a
 927  02d3 81            	ret
 963                     ; 270 void I2C_GenerateSTOP(FunctionalState NewState)
 963                     ; 271 {
 964                     	switch	.text
 965  02d4               _I2C_GenerateSTOP:
 967  02d4 88            	push	a
 968       00000000      OFST:	set	0
 971                     ; 274   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 973  02d5 4d            	tnz	a
 ...
 989  02ef               L211:
 990                     ; 276   if (NewState != DISABLE)
 992  02ef 0d01          	tnz	(OFST+1,sp)
 993  02f1 2706          	jreq	L362
 994                     ; 279     I2C->CR2 |= I2C_CR2_STOP;
 996  02f3 72125211      	bset	21009,#1
 998  02f7 2004          	jra	L562
 999  02f9               L362:
1000                     ; 284     I2C->CR2 &= (uint8_t)(~I2C_CR2_STOP);
1002  02f9 72135211      	bres	21009,#1
1003  02fd               L562:
1004                     ; 286 }
1007  02fd 84            	pop	a
1008  02fe 81            	ret
1045                     ; 294 void I2C_SoftwareResetCmd(FunctionalState NewState)
1045                     ; 295 {
1046                     	switch	.text
1047  02ff               _I2C_SoftwareResetCmd:
1049  02ff 88            	push	a
1050       00000000      OFST:	set	0
1053                     ; 297   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1055  0300 4d            	tnz	a
...
1071  031a               L221:
1072                     ; 299   if (NewState != DISABLE)
1074  031a 0d01          	tnz	(OFST+1,sp)
1075  031c 2706          	jreq	L503
1076                     ; 302     I2C->CR2 |= I2C_CR2_SWRST;
1078  031e 721e5211      	bset	21009,#7
1080  0322 2004          	jra	L703
1081  0324               L503:
1082                     ; 307     I2C->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
1084  0324 721f5211      	bres	21009,#7
1085  0328               L703:
1086                     ; 309 }
1089  0328 84            	pop	a
1090  0329 81            	ret
1127                     ; 318 void I2C_StretchClockCmd(FunctionalState NewState)
1127                     ; 319 {
1128                     	switch	.text
1129  032a               _I2C_StretchClockCmd:
1131  032a 88            	push	a
1132       00000000      OFST:	set	0
1135                     ; 321   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1137  032b 4d            	tnz	a
...
1153  0345               L231:
1154                     ; 323   if (NewState != DISABLE)
1156  0345 0d01          	tnz	(OFST+1,sp)
1157  0347 2706          	jreq	L723
1158                     ; 326     I2C->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
1160  0349 721f5210      	bres	21008,#7
1162  034d 2004          	jra	L133
1163  034f               L723:
1164                     ; 332     I2C->CR1 |= I2C_CR1_NOSTRETCH;
1166  034f 721e5210      	bset	21008,#7
1167  0353               L133:
1168                     ; 334 }
1171  0353 84            	pop	a
1172  0354 81            	ret
1209                     ; 343 void I2C_AcknowledgeConfig(I2C_Ack_TypeDef Ack)
1209                     ; 344 {
1210                     	switch	.text
1211  0355               _I2C_AcknowledgeConfig:
1213  0355 88            	push	a
1214       00000000      OFST:	set	0
1217                     ; 347   assert_param(IS_I2C_ACK_OK(Ack));
1219  0356 4d            	tnz	a
...
1475                     ; 409   assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));
1477  0402 4d            	tnz	a
...
1493  041c               L071:
1494                     ; 411   if (I2C_DutyCycle == I2C_DUTYCYCLE_16_9)
1496  041c 7b01          	ld	a,(OFST+1,sp)
1497  041e a140          	cp	a,#64
1498  0420 2606          	jrne	L734
1499                     ; 414     I2C->CCRH |= I2C_CCRH_DUTY;
1501  0422 721c521c      	bset	21020,#6
1503  0426 2004          	jra	L144
1504  0428               L734:
1505                     ; 419     I2C->CCRH &= (uint8_t)(~I2C_CCRH_DUTY);
1507  0428 721d521c      	bres	21020,#6
1508  042c               L144:
1509                     ; 421 }
1512  042c 84            	pop	a
1513  042d 81            	ret
1536                     ; 428 uint8_t I2C_ReceiveData(void)
1536                     ; 429 {
1537                     	switch	.text
1538  042e               _I2C_ReceiveData:
1542                     ; 431   return ((uint8_t)I2C->DR);
1544  042e c65216        	ld	a,21014
1547  0431 81            	ret
1613                     ; 441 void I2C_Send7bitAddress(uint8_t Address, I2C_Direction_TypeDef Direction)
1613                     ; 442 {
1614                     	switch	.text
1615  0432               _I2C_Send7bitAddress:
1617  0432 89            	pushw	x
1618       00000000      OFST:	set	0
1621                     ; 444   assert_param(IS_I2C_ADDRESS_OK(Address));
...
1637  044b               L002:
1638                     ; 445   assert_param(IS_I2C_DIRECTION_OK(Direction));
...
1671  0475 85            	popw	x
1672  0476 81            	ret
1706                     ; 459 void I2C_SendData(uint8_t Data)
1706                     ; 460 {
1707                     	switch	.text
1708  0477               _I2C_SendData:
1712                     ; 462   I2C->DR = Data;
1714  0477 c75216        	ld	21014,a
1715                     ; 463 }
1718  047a 81            	ret
1943                     ; 579 ErrorStatus I2C_CheckEvent(I2C_Event_TypeDef I2C_Event)
1943                     ; 580 {
1944                     	switch	.text
...
1952                     ; 581   __IO uint16_t lastevent = 0x00;
1954  047e 5f            	clrw	x
1955  047f 1f04          	ldw	(OFST-2,sp),x
1957                     ; 582   uint8_t flag1 = 0x00 ;
1959                     ; 583   uint8_t flag2 = 0x00;
1961                     ; 584   ErrorStatus status = ERROR;
1963                     ; 587   assert_param(IS_I2C_EVENT_OK(I2C_Event));
...
2025  0504               L022:
2026                     ; 589   if (I2C_Event == I2C_EVENT_SLAVE_ACK_FAILURE)
2028  0504 1e07          	ldw	x,(OFST+1,sp)
2029  0506 a30004        	cpw	x,#4
2030  0509 260b          	jrne	L336
2031                     ; 591     lastevent = I2C->SR2 & I2C_SR2_AF;
...
2041  0516               L336:
2042                     ; 595     flag1 = I2C->SR1;
2044  0516 c65217        	ld	a,21015
2045  0519 6b03          	ld	(OFST-3,sp),a
2047                     ; 596     flag2 = I2C->SR3;
2049  051b c65219        	ld	a,21017
2050  051e 6b06          	ld	(OFST+0,sp),a
2052                     ; 597     lastevent = ((uint16_t)((uint16_t)flag2 << (uint16_t)8) | (uint16_t)flag1);
...
2071  0535               L536:
2072                     ; 600   if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event)
...
2210  057d               L376:
2211                     ; 649   return (I2C_Event_TypeDef)lastevent;
2213  057d 1e05          	ldw	x,(OFST-1,sp)
2216  057f 5b06          	addw	sp,#6
2217  0581 81            	ret
2433                     ; 680 FlagStatus I2C_GetFlagStatus(I2C_Flag_TypeDef I2C_Flag)
2433                     ; 681 {
2434                     	switch	.text
...
2442                     ; 682   uint8_t tempreg = 0;
2444  0584 0f02          	clr	(OFST+0,sp)
2446                     ; 683   uint8_t regindex = 0;
2448                     ; 684   FlagStatus bitstatus = RESET;
2450                     ; 687   assert_param(IS_I2C_FLAG_OK(I2C_Flag));
...
2496  05e9               L232:
2497                     ; 690   regindex = (uint8_t)((uint16_t)I2C_Flag >> 8);
2499  05e9 7b03          	ld	a,(OFST+1,sp)
2500  05eb 6b01          	ld	(OFST-1,sp),a
2502                     ; 692   switch (regindex)
...
2514  05fa               L576:
2515                     ; 695     case 0x01:
2515                     ; 696       tempreg = (uint8_t)I2C->SR1;
...
2523  0601               L776:
2524                     ; 700     case 0x02:
2524                     ; 701       tempreg = (uint8_t)I2C->SR2;
...
2532  0608               L107:
2533                     ; 705     case 0x03:
2533                     ; 706       tempreg = (uint8_t)I2C->SR3;
...
2622                     ; 762   uint16_t flagpos = 0;
2624                     ; 764   assert_param(IS_I2C_CLEAR_FLAG_OK(I2C_FLAG));
...
2647  0643               L042:
2648                     ; 767   flagpos = (uint16_t)I2C_FLAG & FLAG_Mask;
...
2659                     ; 769   I2C->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
2668  0657 81            	ret
2835                     ; 792 ITStatus I2C_GetITStatus(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2835                     ; 793 {
2836                     	switch	.text
...
2844                     ; 794   ITStatus bitstatus = RESET;
2846                     ; 795   __IO uint8_t enablestatus = 0;
2848  065b 0f03          	clr	(OFST-1,sp)
2850                     ; 796   uint16_t tempregister = 0;
2852                     ; 799     assert_param(IS_I2C_ITPENDINGBIT_OK(I2C_ITPendingBit));
...
2890  06ac               L052:
2891                     ; 801   tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_ITPendingBit & ITEN_Mask)) >> 8);
2893  06ac 7b05          	ld	a,(OFST+1,sp)
2894  06ae a407          	and	a,#7
2895  06b0 5f            	clrw	x
2896  06b1 97            	ld	xl,a
2897  06b2 1f01          	ldw	(OFST-3,sp),x
2899                     ; 804   enablestatus = (uint8_t)(I2C->ITR & ( uint8_t)tempregister);
2901  06b4 c6521a        	ld	a,21018
2902  06b7 1402          	and	a,(OFST-2,sp)
2903  06b9 6b03          	ld	(OFST-1,sp),a
2905                     ; 806   if ((uint16_t)((uint16_t)I2C_ITPendingBit & REGISTER_Mask) == REGISTER_SR1_Index)
...
2917                     ; 809     if (((I2C->SR1 & (uint8_t)I2C_ITPendingBit) != RESET) && enablestatus)
...
3021                     ; 875   uint16_t flagpos = 0;
3023                     ; 878   assert_param(IS_I2C_CLEAR_ITPENDINGBIT_OK(I2C_ITPendingBit));
...
3047  0726               L062:
3048                     ; 881   flagpos = (uint16_t)I2C_ITPendingBit & FLAG_Mask;
...
3059                     ; 884   I2C->SR2 = (uint8_t)((uint16_t)~flagpos);
...
3102                     	switch	.const
3103  0008               L131:
3104  0008 73746d38735f  	dc.b	"stm8s_stdperiph_dr"
3105  001a 697665725c73  	dc.b	"iver\src\stm8s_i2c"
3106  002c 2e6300        	dc.b	".c",0
3107                     	xref.b	c_lreg
3108                     	xref.b	c_x
3128                     	xref	c_sdivx
3129                     	xref	c_bmulx
